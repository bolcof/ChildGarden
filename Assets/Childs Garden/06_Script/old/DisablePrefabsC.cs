...
public class DisablePrefabsC : Photon.MonoBehaviour
{
...
{
    string testB_0822 = "testB_0822"; // 次のシーンの名前に書き換えてください
    photonView.RPC("RequestSceneChange", PhotonNetwork.masterClient, testB_0822);
}
